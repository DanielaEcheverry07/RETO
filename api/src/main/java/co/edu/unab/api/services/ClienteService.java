...
public class ClienteService {
    ...
    public ArrayList<ClienteModel> ClientePorNombreApellido(String nombre, String apellido){
        
        return clienteRepository.findByNombreApellido(nombre, apellido);
    }
    public ArrayList<ClienteModel> ClienteMayor(Long puntos){
        
        return clienteRepository.findByPuntosGreaterThanEqual(puntos);
    }
    public ArrayList<ClienteModel> ClienteMenor(Long puntos){
